...
<head>
    ...
    <title>쇼핑을 쉽게, 스타일링을 즐겁게! 오늘의집 스토어</title>
            ...
            <svg width="88" height="31" viewBox="0 0 88 31" preserveAspectRatio="xMidYMid meet">
                <g fill="none" fill-rule="evenodd">
                    ...
                    <g fill="#000">
                        ...
                        <path
                            d="M72.64 5.096c-.56 0-1.016.452-1.016 1.01v12.358c-1.345.417-4.016.784-7.251.784h-1.546c-.56 0-1.015.452-1.015 1.01 0 .557.454 1.009 1.015 1.009h1.546c1.846 0 5.04-.161 7.251-.708v3.362c0 .558.455 1.01 1.016 1.01.56 0 1.015-.452 1.015-1.01V6.106c0-.558-.454-1.01-1.015-1.01">
                        </path>
                    </g>
                </g>
            </svg>
        ...
        <div class="join-main">
            ...
            <div class="sns">
                ...
                <ul class="sns-icon-list">
                    <li class="sns-icon">
                        <a href="https://ko-kr.facebook.com/" title="페이스북으로 가입하기" class="css-4zleql e111gxds0">
                    ...
                    <li class="sns-icon">
                        <a href="https://www.kakaocorp.com/page/service/service/KakaoTalk" title="카카오톡으로 가입하기"
                            class="css-4zleql e111gxds0">
                            <svg width="48" height="48" viewBox="0 0 48 48" preserveAspectRatio="xMidYMid meet">
                                <g fill="none" fill-rule="evenodd">
                                    <path fill="#FFEB00"
                                        d="M0 24C0 10.745 10.745 0 24 0s24 10.745 24 24-10.745 24-24 24S0 37.255 0 24z">
                    ...
                    <li class="sns-icon">
                        <a href="https://www.naver.com/" title="네이버로 가입하기" class="css-4zleql e111gxds0"><svg width="48"
                                height="48" viewBox="0 0 48 48" preserveAspectRatio="xMidYMid meet">
                                <g fill="none" fill-rule="evenodd">
                                    <path fill="#00C63B"
                                        d="M0 24C0 10.745 10.745 0 24 0s24 10.745 24 24-10.745 24-24 24S0 37.255 0 24z">
                                    </path>
            ...
            <form action="joinAction.member">
                <div class="email">
                    <p>이메일</p>
                    <div>
                        <span>
                            <div id="email-first">
                                <input type="text" placeholder="이메일" name="memberIdentification">
                            </div>
                        </span>
                        <span>@</span>
                        <span>
                            <label>
                                <select name="" id="email-last">
                                ...
                                <button id="domain-expand" type="button">
                ...
                <div class="email-varify">
                    <button id="email-varify-btn" class="buttons buttons-text" type="button">이메일 인증하기</button>
                </div>
                <div class="password forms">
                    <p>비밀번호</p>
                    <p class="input-condition-text">영문, 숫자를 포함한 8자 이상의 비밀번호를 입력해주세요.</p>
                    <span>
                        <input class="inputs" name="memberPassword" type="password" placeholder="비밀번호" >
                    </span>
                </div>
                <div class="password-varify forms">
                    <p>비밀번호 확인</p>
                    <span>
                        <input class="inputs" name="memberPassword" type="password" placeholder="비밀번호 확인">
                    </span>
                </div>
                <div class="nickname forms">
                    <p>닉네임</p>
                    <p class="input-condition-text">다른 유저와 겹치지 않도록 입력해주세요. (2~15자)</p>
                    <span>
                        <input class="inputs" name="memberPassword" type="password" placeholder="별명 (2~15)자">
                    </span>
                </div>
                <div class="terms forms">
                    <p>닉네임</p>
                    <div class="terms-list">
                        <div class="terms-title">
                            <div class="checkbox">
                                <input type="checkbox" value="false" name="agreeAll">
                            </div>
                            <span>
                                <span id="selectAll">
                                    전체동의
                        ...
                        <div class="terms-title">
                            ...
                            <span class="conditions necessary">
                                만 14세 이상입니다
                            </span>
                        </div>
                        <div class="terms-title terms-title-margin">
                            <div class="checkbox">
                                <input type="checkbox" value="false" name="agreeAll">
                            </div>
                            <span class="conditions necessary">
                        ...
                        <div class="terms-title terms-title-margin">
                            ...
                            <span class="conditions unnecessary">
                                개인정보 마케팅 활용 동의
                            </span>
                        </div>
                        <div class="terms-title terms-title-margin">
                ...
                <button id="join-btn" type="submit" class="buttons buttons-text">회원가입하기</button>
            </form>
            <p class="login">
                이미 아이디가 있으신가요?
                <a href="login.html" class="css-i9fa3q e1y3odo20">
                    로그인
                </a>
            </p>
        </div>
